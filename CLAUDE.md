...
**始终阅读 DESIGN.md** 在进行任何视觉或 UI 更改之前。

设备状态四态规范：
- 扫描中：#9CA3AF (灰色) + SyncOutlined 旋转图标
- 连接中：#F59E0B (黄色) + WifiOutlined 图标
- 在线：#10B981 (绿色) + 正常显示
- 离线：#6B7280 (深灰色) + 透明度 0.6

所有颜色、间距和审美方向都在 DESIGN.md 中定义。未经用户明确批准，不得偏离。
